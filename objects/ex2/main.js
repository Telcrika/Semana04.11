...
class avatar {
  constructor(usuario){//passando o objeto inteiro
    this.usuario = usuario;
  }
  render(){//o nome render pode ser substituido por qualquer outro nome, ele aqui atua como uma simples função.
    const avatar = `<div class>`
